...
def linen_prepare(input_folder,
    ...
    def path_definer(input_folder,
        ...
        path_linen = os.path.join(path, residue_name + '_linen')

        if os.path.exists(path_linen) == False:
            os.mkdir(path_linen)

        return path, path_previous_simulation, path_linen
    ...
    def write_files(force_field,
        ...
        path_to_run = os.path.join(path_linen, 'run')

        with open(os.path.join(path_linen, 'pele.conf'), 'w') as fileout:
        ...
        with open(path_to_run, 'w') as fileout:
            ...
            fileout.writelines(
                ...
                path_linen + '/pele.conf --license-directory /gpfs/projects/bsc72/PELE++/license\n'
            )

        with open(os.path.join(path_linen, 'run_analysis'), 'w') as fileout:
        ...
        with open(os.path.join(path_linen, 'script.py'), 'w') as fileout:
    ...
    path, path_previous_simulation, path_linen = \
